...
//  Project8
//
//  Created by leticia.dayane on 30/01/24.
//
...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        //arrumando o layout do app tornando-os esticáveis
    ...
    @objc func letterTapped(_ sender: UIButton) {
        ...
        //challenge project15
        if activedButtons.contains(sender) {
    ...
    //função para carregar o próximo nível disponível no alerta
